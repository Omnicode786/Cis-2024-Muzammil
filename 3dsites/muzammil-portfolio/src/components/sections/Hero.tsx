...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden px-4 pb-16 pt-32 md:px-8 md:pt-36" aria-label="Systems engineer hero">
      ...
      <div data-hero-reveal className="pointer-events-none absolute left-1/2 top-24 z-0 w-[115vw] -translate-x-1/2 text-center font-display text-[18vw] font-black uppercase leading-none tracking-[-0.09em] text-[#20302d]/[0.045] sm:top-20 sm:text-[15vw]">
        Muzammil Alam
      </div>
      <div className="relative z-10 mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.03fr_0.97fr] lg:items-end">
        <div>
          <p data-hero-reveal className="mb-5 font-display text-5xl font-black uppercase leading-none tracking-[-0.06em] text-[#20302d] sm:text-7xl lg:text-8xl">
            Muzammil Alam
          </p>
          <div data-hero-reveal className="mb-8 inline-flex max-w-full items-center gap-3 rounded-full border border-system-cyan/35 bg-white/72 px-4 py-3 font-mono text-[11px] font-black uppercase tracking-[0.2em] text-[#386d70] shadow-[0_20px_60px_rgba(101,207,215,0.16)] backdrop-blur-2xl">
            <Zap size={15} className="text-[#678b42]" />
            Future systems engineer // Karachi
          </div>

          <h1 data-hero-reveal className="max-w-5xl font-display text-5xl font-black uppercase leading-[0.9] tracking-normal text-[#20302d] sm:text-7xl lg:text-8xl xl:text-9xl">
          ...
          <p data-hero-reveal className="mt-8 max-w-2xl text-lg font-semibold leading-8 text-[#526861] md:text-xl">
        ...
        <div className="grid gap-4">
          <div data-hero-reveal className="soft-card rounded-[2rem] p-5">
          ...
          <div data-hero-reveal className="terminal-scanline rounded-[2rem] border border-system-lime/30 bg-[#fbfff5]/78 p-5 font-mono text-xs text-[#4e6a43] shadow-[0_28px_70px_rgba(118,150,110,0.14)] backdrop-blur-xl">
      ...
      <svg data-hero-reveal className="pointer-events-none absolute bottom-10 right-6 hidden h-40 w-40 text-[#65cfd7]/45 md:block" viewBox="0 0 120 120" fill="none" aria-hidden="true">
