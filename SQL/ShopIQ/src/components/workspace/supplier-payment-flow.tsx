...
export function SupplierPaymentFlow({ suppliers, canCreate }: { suppliers: SupplierOption[]; canCreate: boolean }) {
  ...
  async function submit(event: FormEvent) {
    ...
    if (!canCreate) return;
    if (!form.supplierId) {
      stopWithMessage("Choose a supplier to record a payment.");
      return;
    }
            ...
            <form onSubmit={submit} noValidate>
              <div className="crud-modal-heading">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm leading-6 text-muted-foreground">Adjust a supplier's balance directly by recording a payment out.</p>
                </div>
                  ...
                  <section className="billing-flow-section">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <label className="crud-field sm:col-span-2">
                        <span className="crud-field-label">Supplier <i aria-hidden="true">*</i></span>
