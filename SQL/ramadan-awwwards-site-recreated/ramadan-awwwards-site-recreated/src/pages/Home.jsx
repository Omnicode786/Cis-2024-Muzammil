    ...
    <div>
      ...
      <section className="px-6 pb-10 pt-8 md:px-8 lg:px-12 lg:pt-16">
        <motion.div
          ...
          className="theme-card mx-auto max-w-7xl rounded-[2rem] bg-[radial-gradient(circle_at_top,rgba(250,204,21,0.1),transparent_45%)] p-8 md:p-10"
        >
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              <p className="text-xs uppercase tracking-[0.45em] text-[var(--theme-accent-strong)]">For first-time visitors</p>
              <h2 className="mt-4 font-display text-4xl leading-none text-[var(--theme-text)] md:text-5xl">
                Ramadan is at once deeply personal and beautifully communal.
              </h2>
            </div>
            <p className="text-base leading-8 text-[var(--theme-muted)] md:text-lg">
