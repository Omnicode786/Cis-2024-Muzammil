  ...
  return (
    <div>
      ...
      <section className="px-6 pb-16 pt-8 md:px-8 lg:px-12 lg:pb-20">
        <div className="mx-auto max-w-5xl theme-card rounded-[2rem] p-8 text-center md:p-12">
          <p className="text-xs uppercase tracking-[0.45em] text-[var(--theme-accent-strong)]">A helpful lens</p>
          <p className="mt-6 font-display text-3xl leading-tight text-[var(--theme-text)] md:text-4xl">
            If Ramadan seems quiet from the outside, that quiet often holds the deepest beauty.
          </p>
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-[var(--theme-muted)] md:text-lg">
